...
# printer det fulde k-space eller fulde billede
#plt.imshow(np.log(np.abs(kspace)+1E-09), cmap='gray', vmin = vmin_k, vmax = vmax_k) # plotter fuldt kspace alene
#plt.imshow(np.abs(image),cmap='gray', vmin = vmin_i, vmax = vmax_i) # plotter det "perfekte" billede alene
#plt.axis('off')
#plt.show()
